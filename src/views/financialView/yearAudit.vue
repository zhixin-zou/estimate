    ...
    init() {
      $http
        ...
        .then((data) => {
          ...
          // console.log(data, data.data.data.beforeInfo, 'beforeInfo')
          let datas = "";
          ...
          this.feeInfoList.push(res.data.feeInfo);
          this.cedentList = res.data.cedentList;
          let obj = { policyMonth: "UPR 分布" };
          this.uprRateList = res.data.uprRateList;
          ...
          let uprSplitInfo = res.data.uprEstimateList;
