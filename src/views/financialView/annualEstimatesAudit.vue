      ...
      $http
        ...
        .then((data) => {
          ...
          if (sessionStorage.getItem("opreatAudit") === "before") {
            ...
            datas = data.data.data.afterInfo;
          }
          let res = "";
          if (datas !== "") {
          ...
          if (res.code === "0") {
            ...
            this.totalEPI = res.data.epiSplitInfo.totalEPI;
            this.EPIData = res.data.epiSplitInfo.epiSplitList;
            this.calculatedFeeList = res.data.calculatedFeeList;
            this.calculatedFeeList2 = res.data.calculatedFeeList;

            this.iabSlidingScaleAdjustRate =
              res.data.contractInfo.iabSlidingScaleAdjustRate;
            this.orpSlidingScaleAdjustRate =
              res.data.contractInfo.orpSlidingScaleAdjustRate;
            this.commRate = res.data.contractInfo.commRate;
            this.provCommRate = res.data.contractInfo.provCommRate;
            this.brokerageRate = res.data.contractInfo.brokerageRate;
            this.cedentRate = res.data.contractInfo.cedentRate;
            console.log(
              this.commRate,
              this.provCommRate,
              this.brokerageRate,
              "this.brokerageRatethis.brokerageRatethis.brokerageRatethis.brokerageRate"
            );
    ...
    handleTotalEPI() {
      ...
      $http
        .post(api.yearTotalEPIAdjust, {
          ...
          estimateKey: sessionStorage.getItem("cwNAuditEstimateKey"),
          estimateMonth: sessionStorage.getItem("cwNAuditEstimateMonth"),
        })
        .then((res) => {
          if (res.data.code === "0") {
