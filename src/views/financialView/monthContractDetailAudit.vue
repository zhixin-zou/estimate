<template>
  <div class="monthContractDetial">
    ...
    <div class="monthHeader">
      <el-button @click="handleExport('cwMonthWorkSheet', '分入账单信息')"
        >导出</el-button
      >
    </div>
    <div class="separateInfo">
      ...
      $http
        ...
        .then((data) => {
          ...
          if (res.code == "0") {
            ...
            let epiSplitInfo = res.data.epiSplitInfo;
            localStorage.setItem(
              "epiDatacopy",
              JSON.stringify(res.data.epiSplitInfo.epiSplitList)
            );
    ...
    handleTotalEPI() {
      ...
      $http
        .post(api.monthTotalEPIAdjust, {
          ...
          estimateKey: sessionStorage.getItem("cwMAuditEstimateKey"),
        })
        .then((res) => {
          if (res.data.code == "0") {
