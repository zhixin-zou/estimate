...
export const getFinishDate = (value) => {
        ...
        var str = value.getFullYear() + '-' + (value.getMonth() + 1) + '-' + value.getDate() + ' 23:59:59.999'
        return new Date(str)
    }
    /**
      返回当天的23:59:59秒时间
...
export const getFinishDateNew = (value) => {
    value = new Date(value)
    var str = value.getFullYear() + '-' + (value.getMonth() + 1) + '-' + value.getDate() + ' 23:59:59.000'
    return new Date(str)
}
...
export const getStartDate = (value) => {
    value = new Date(value)
    var str = value.getFullYear() + '-' + (value.getMonth() + 1) + '-' + value.getDate() + ' 00:00:00'
    return new Date(str)
}
...
export const getParamsUrl = data => {
    ...
    for (let key in data) {
        if (Array.isArray(data[key])) {
            ...
            params += params.indexOf('?') > -1 ? '&' + key + '=' + value : '?' + key + '=' + value
        } else {
            params += params.indexOf('?') > -1 ? '&' + key + '=' + data[key] : '?' + key + '=' + data[key]
        }
    }
    return params
}
